...
def authenticate_user(db_manager):
    ...
    while True:
        ...
        if choice == '1':
            ...
            if db_manager.signup_user(username, password):
                print("Account created! Please login now.")
            else:
                print("Signup failed. Try a different username.")
        else:
            print("Invalid choice. Please enter 1 or 2.")


def add_new_student(db_manager):
    ...
    try:
        ...
        if not validate_index(index_number):
            print("Error: Invalid index number format.")
            return
        ...
        if len(course) < 2:
            print("Error: Course name must be at least 2 characters long.")
            return
        ...
        student_data = (index_number, full_name, course, score)
        
        if db_manager.insert_student(student_data):
...
def main():
    ...
    try:
        ...
        # Authenticate user
        if not authenticate_user(db_manager):
