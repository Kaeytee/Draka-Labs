...
class ReportGenerator:
    ...
    def generate_summary_report(self):
        ...
        try:
            ...
            report_content = self._format_report(total_students, grade_distribution, average_score)
    ...
    def _format_report(self, total_students, grade_distribution, average_score):
        ...
        if total_students == 0:
            ...
            if grade_distribution:
                ...
                report.append(f"Most common grade: {most_common_grade} ({grade_distribution[most_common_grade]} students)")
            
            # Performance insights
            excellent_count = grade_distribution.get('A', 0)
            if excellent_count > 0:
                excellent_rate = (excellent_count / total_students) * 100
                report.append(f"Excellent performance (A): {excellent_rate:.1f}%")
            
            if failing_count > 0:
                report.append(f"Students needing support (F): {failing_count}")
